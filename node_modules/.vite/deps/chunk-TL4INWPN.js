...
import {
  ...
  set_should_intro,
  should_intro
} from "./chunk-XYD2STLF.js";
import {
  create_event,
  delegate,
  delegated
} from "./chunk-IR3LHTYL.js";
import {
  ATTACHMENT_KEY,
  ATTRIBUTES_CACHE,
  BLOCK_EFFECT,
...
function snippet(node, get_snippet, ...args) {
  ...
  block(() => {
    ...
    if (false_default && snippet2 == null) {
      invalid_snippet();
    }
...
function createRawSnippet(fn) {
  return (anchor, ...params) => {
    ...
    if (hydrating) {
      ...
      if (false_default && (get_next_sibling(element2) !== null || element2.nodeType !== ELEMENT_NODE)) {
        invalid_raw_snippet_render();
      }
...
function element(node, get_tag, is_svg, render_fn, get_namespace, location) {
  ...
  var filename = false_default && location && component_context?.function[FILENAME];
  var element2 = null;
...
function rest_props(props, exclude, name) {
  return new Proxy(
    false_default ? { props, exclude, name, other: {}, to_proxy: [] } : { props, exclude },
    rest_props_handler
  );
}
...
//# sourceMappingURL=chunk-TL4INWPN.js.map
